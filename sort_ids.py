...
def _p_main(item: X1) -> None:
    ...
    del_keys(item, "desc", "")
    del_keys(item, "fan_share_image", "")
    del_keys(item, "fan_user", _EMPTY_FAN_USER, recursive=False)
    del_keys(item, "finish_sources", None)
    del_keys(item, "first_up", operator=OPR.ANY)
    del_keys(item, "grant_time", "")
    del_keys(item, "gray_rule_type", operator=OPR.ANY)
    del_keys(item, "gray_rule", operator=OPR.ANY)
    del_keys(item, "head_myself_mp4_bg", "")
    del_keys(item, "head_myself_squared_bg", "")
    del_keys(item, "hot", operator=OPR.ANY)
    del_keys(item, "image_bright", "")
    del_keys(item, "image_cover_color", "")
    del_keys(item, "image_cover", "")
    del_keys(item, "image_dim", "")
    del_keys(item, "image_enhance_frame", "")
    del_keys(item, "image_enhance", "")
    del_keys(item, "image_gif", "")
    del_keys(item, "image_preview_big", "")
    del_keys(item, "image_preview_small", "")
    del_keys(item, "image1_landscape", "")
    del_keys(item, "image1_portrait", "")
    del_keys(item, "image2_landscape", "")
    del_keys(item, "image2_portrait", "")
    del_keys(item, "image3_landscape", "")
    del_keys(item, "image3_portrait", "")
    del_keys(item, "image4_landscape", "")
    del_keys(item, "image4_portrait", "")
    ...
    del_keys(item, "price_bp", "")
    del_keys(item, "price_coin", "")
    ...
    del_keys(item, "sale_time_begin", operator=OPR.ANY)
    del_keys(item, "sale_time_end", 0, OPR.LEQ)
    del_keys(item, "sale_time_end", operator=OPR.ANY, recursive=False)
    del_keys(item, "sale_time_end", operator=OPR.ANY)
    del_keys(item, "sales_mode", 0)
    del_keys(item, "setting_pannel_not_show", operator=OPR.ANY)
    del_keys(item, "sortable", operator=OPR.ANY)
    del_keys(item, "space_1_mp4_horizontal", "")
    del_keys(item, "space_1_mp4_vertical", "")
    del_keys(item, "space_2_mp4_horizontal", "")
    del_keys(item, "space_2_mp4_vertical", "")
    del_keys(item, "space_3_mp4_horizontal", "")
    del_keys(item, "space_3_mp4_vertical", "")
    del_keys(item, "space_4_mp4_horizontal", "")
    del_keys(item, "space_4_mp4_vertical", "")
    del_keys(item, "space_5_mp4_horizontal", "")
    del_keys(item, "space_5_mp4_vertical", "")
    del_keys(item, "space_6_mp4_horizontal", "")
    del_keys(item, "space_6_mp4_vertical", "")
    del_keys(item, "space_7_mp4_horizontal", "")
    del_keys(item, "space_7_mp4_vertical", "")
    del_keys(item, "space_8_mp4_horizontal", "")
    del_keys(item, "space_8_mp4_vertical", "")
    del_keys(item, "space_9_mp4_horizontal", "")
    del_keys(item, "space_9_mp4_vertical", "")
