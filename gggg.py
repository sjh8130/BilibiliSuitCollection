...
def _p_main(item: X1) -> None:
    ...
    _del_keys(item, "desc", "")
    _del_keys(item, "fan_share_image", "")
    ...
    _del_keys(item, "grant_time", "")
    _del_keys(item, "gray_rule_type", operator=OPR.ANY)
    _del_keys(item, "gray_rule", operator=OPR.ANY)
    _del_keys(item, "head_myself_mp4_bg", "")
    _del_keys(item, "head_myself_squared_bg", "")
    _del_keys(item, "hot", operator=OPR.ANY)
    _del_keys(item, "image_bright", "")
    _del_keys(item, "image_cover_color", "")
    _del_keys(item, "image_cover", "")
    _del_keys(item, "image_dim", "")
    _del_keys(item, "image_enhance_frame", "")
    _del_keys(item, "image_enhance", "")
    _del_keys(item, "image_gif", "")
    _del_keys(item, "image_preview_big", "")
    _del_keys(item, "image_preview_small", "")
    _del_keys(item, "image1_landscape", "")
    _del_keys(item, "image1_portrait", "")
    _del_keys(item, "image2_landscape", "")
    _del_keys(item, "image2_portrait", "")
    _del_keys(item, "image3_landscape", "")
    _del_keys(item, "image3_portrait", "")
    _del_keys(item, "image4_landscape", "")
    _del_keys(item, "image4_portrait", "")
    ...
    _del_keys(item, "price_bp", "")
    _del_keys(item, "price_coin", "")
    ...
    _del_keys(item, "space_1_mp4_horizontal", "")
    _del_keys(item, "space_1_mp4_vertical", "")
    _del_keys(item, "space_2_mp4_horizontal", "")
    _del_keys(item, "space_2_mp4_vertical", "")
    _del_keys(item, "space_3_mp4_horizontal", "")
    _del_keys(item, "space_3_mp4_vertical", "")
    _del_keys(item, "space_4_mp4_horizontal", "")
    _del_keys(item, "space_4_mp4_vertical", "")
    _del_keys(item, "space_5_mp4_horizontal", "")
    _del_keys(item, "space_5_mp4_vertical", "")
    _del_keys(item, "space_6_mp4_horizontal", "")
    _del_keys(item, "space_6_mp4_vertical", "")
    _del_keys(item, "space_7_mp4_horizontal", "")
    _del_keys(item, "space_7_mp4_vertical", "")
    _del_keys(item, "space_8_mp4_horizontal", "")
    _del_keys(item, "space_9_mp4_horizontal", "")
    _del_keys(item, "space_9_mp4_vertical", "")
